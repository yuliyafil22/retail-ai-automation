...
В публичной версии репозитория представлена только **демонстрационная часть** проекта: описание, архитектура и скриншоты.

Полный исходный код (AI аналитика, Telegram бот, интеграции с CRM и Supabase) не публикуется для сохранения уникальности решения и коммерческой тайны.

Приглашаю к сотрудничеству и готова обсудить детали реализации на собеседовании.
